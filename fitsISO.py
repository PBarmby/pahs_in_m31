...
#Plots ISO CVF cube figure from the nucleus with the extraction aperture.
...
gc = aplpy.FITSFigure('iso.fits', subplot=(1, 1, 1), north=True) #
gc.show_regions('region4cubes.reg') # upload some regions in the ds9 format
...
gc.add_label(0.15, 0.9, 'ISOCVF', size='x-large', family='sans-serif', relative=True)
#
