...
#####################################################################
#Plotting with colors. Comment this section and uncomment the below section to get the black n white section.
...
fn = get_sample_data("silicate.png", asfileobj=False)
